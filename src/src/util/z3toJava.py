...
z3OptoStr = {
    Z3_OP_TRUE : 'True', Z3_OP_FALSE : 'False', Z3_OP_EQ : '==', Z3_OP_DISTINCT : '!=', 
    Z3_OP_ITE : 'If', Z3_OP_AND : '&&', Z3_OP_OR : '||', Z3_OP_IFF : '==', Z3_OP_XOR : '^',
    Z3_OP_NOT : '!', Z3_OP_IMPLIES : 'Implies', Z3_OP_IDIV : '/', Z3_OP_MOD : '%',
    ...
    Z3_OP_BNOT : '~', Z3_OP_BXOR : '^', Z3_OP_BNEG : '-', Z3_OP_BUDIV : '/', Z3_OP_BSDIV : '/', Z3_OP_BSMOD : '%',
...
def unparse_symbol(z3symbol:z3.ExprRef, symmap:dict[Sequence[Tuple[str, str]], JBSESymbol]):
